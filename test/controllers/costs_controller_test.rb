...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { count: @cost.count, date: @cost.date, description: @cost.description, folder_id: @cost.folder_id, item: @cost.item, mode: @cost.mode, price: @cost.price }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { count: @cost.count, date: @cost.date, description: @cost.description, folder_id: @cost.folder_id, item: @cost.item, mode: @cost.mode, price: @cost.price }
    assert_redirected_to cost_path(assigns(:cost))
  end
