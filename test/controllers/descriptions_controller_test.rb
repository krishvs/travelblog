...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { description: @description.description, folder_id: @description.folder_id, mode: @description.mode, title: @description.title }
    end
  ...
  test "should update description" do
    patch :update, id: @description, description: { description: @description.description, folder_id: @description.folder_id, mode: @description.mode, title: @description.title }
    assert_redirected_to description_path(assigns(:description))
  end
