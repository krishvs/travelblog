...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { description: @map.description, mode: @map.mode, name: @map.name, transport: @map.transport }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { description: @map.description, mode: @map.mode, name: @map.name, transport: @map.transport }
    assert_redirected_to map_path(assigns(:map))
  end
