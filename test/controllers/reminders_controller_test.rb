...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { description: @reminder.description, mode: @reminder.mode, name: @reminder.name, sent: @reminder.sent }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { description: @reminder.description, mode: @reminder.mode, name: @reminder.name, sent: @reminder.sent }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
